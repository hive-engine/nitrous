...
export const APP_NAME = 'BuildIt';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'BuildIt';
export const APP_NAME_UPPERCASE = 'BUILDIT';
export const APP_ICON = 'build-it';

// FIXME figure out best way to do this on both client and server from env
// vars. client should read $STM_Config, server should read config package.
export const APP_URL = 'https://www.build-it.io';
export const APP_DOMAIN = 'www.build-it.io';
...
export const TAG_LIST = fromJSOrdered({
    ...
    diy: ['how-to', 'tutorial', 'repair'],
    food: ['recipe', 'diet'],
    home: ['gardening', 'furniture', 'construction', 'homesteading'],
    art: ['photography', 'crafts', 'design'],
    technology: ['code', 'electronics', 'computers', 'automation'],
    automotive: ['cars', 'motorbikes', 'trucks'],
});
...
export const SITE_DESCRIPTION =
    ...
    'creating and curating content. It leverages a robust digital points system, called BUILD, that ' +
...
export const COMMUNITY_CATEGORY = 'hive-129017';
