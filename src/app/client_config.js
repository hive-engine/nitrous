...
export const APP_NAME = 'TwoAndTwoIsFour';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'TwoAndTwoIsFour';
export const APP_NAME_UPPERCASE = 'TWOANDTWOISFOUR';
export const APP_ICON = 'tatif';
// FIXME figure out best way to do this on both client and server from env
// vars. client should read $STM_Config, server should read config package.
export const APP_URL = 'https://www.2and2is4.com';
export const APP_DOMAIN = 'www.2and2is4.com';
// max num of tags. if unset, default is 10. This is due to previous hardcoded number.
export const APP_MAX_TAG = 10;
export const SCOT_TAG = 'tatif';
export const TAG_LIST = fromJSOrdered(['tatif']);
export const LIQUID_TOKEN = 'TATIF';
// sometimes it's impossible to use html tags to style coin name, hence usage of _UPPERCASE modifier
export const LIQUID_TOKEN_UPPERCASE = 'TATIF';
// used as backup
export const SCOT_DENOM = 100000000;
export const VOTE_WEIGHT_DROPDOWN_THRESHOLD = 1;
export const VESTING_TOKEN = 'TATIF POWER';
...
export const SITE_DESCRIPTION =
    'TwoAndTwoIsFour is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called TATIF, that ' +
