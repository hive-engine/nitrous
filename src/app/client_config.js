...
export const APP_NAME = 'BattleGames';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'BattleGames';
export const APP_NAME_UPPERCASE = 'BATTLEGAMES';
export const APP_ICON = 'battlegames';
...
export const VESTING_TOKEN = 'BATTLE POWER';
export const INTERLEAVE_PROMOTED = true;
export const PROMOTED_POST_ACCOUNT = 'battlegames';
