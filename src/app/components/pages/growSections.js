...
On Marlians.com, it is **"true celebrity-hood for everyone, once and for all"**. We measure our success in terms of **'real human growth'**. We want to create **more value for 'humans'** in a world were cryptokitties, superman, millionaire-cats, human-clones etc is beginning to garner more value than 'humans'.

Thus, we will incessantly seek innovative ways of inciting each user to **'mine the human' into its awesomest version**. In the future, we will seek to celebrate a world filled with **'true celebrities'**, using the [MARLIANS](https://steem-engine.com/?p=market&t=MARLIANS) tokens too, rewarding the resulting 'breakthrough in human'.
...
Across our ecosystem, we have 4 TV(s) i.e [Marlians](https://www.youtube.com/channel/UCH4tvTSFkjn3KqNQfJVWITQ), [UloggersTV](https://www.youtube.com/channel/UCzI3Rjamg7zSe_o0BwSeIQQ), [UntalentedTV](https://www.youtube.com/channel/UCq6ylwOaSG9VDYwZkMr3jMw) and [TeardropsTV](https://www.youtube.com/channel/UCnIJlzMZzfrcE0bXabLpXKw). We seek to use the media from each TV to impact the world and you can help matters. **We welcome your contributions**. We will feature your contribution on a corresponding TV. **In the future, your contributions may feature in our Uloggers Game App**.  

While we only feature *'certified uloggers'* on our TV(s), if you are not yet a [*'certified ulogger'*](https://ulogs.org/discover) and you submit a video, **we will also look to feature your video** and once we do so, **we will consider giving you a 'certified' status**.
`;
...
**Our ecosystem seeks to unite every steem community**, creating balance in the steem ecosystem. We are doing this by creating 'mini-communities' for every steem-community right on 'marlians.com' e.g [#creativecoin](https://www.marlians.com/created/creativecoin), [#utopian-io](https://www.marlians.com/created/utopian-io), [#actifit](https://www.marlians.com/created/actifit) etc and designating some stake to empower and grow these communities.
...
*You are a celebrity and we are your fan.* As we continue to **grow our network of 'certified' users**, we may find some who have social influence whether on steem or outside steem. **Extra clout** goes a long way in creating awareness for your projects, dreams or you. **Clout** can take different forms too e.g a certified user with some 1.7 million YouTube subscribers may be willing to give your product a shoutout on one of his viral videos etc. 

Check out our list to **find out what our 'certified' users have in stock for you**.
`;
...
**You may want to send us something.** *We will give you our mailing address*. **We want to receive too; for 'receiving is an art'.**
`;

export const inspireUs = `
Marlians.com is modeled to each incite users to 'mine their human'. We seek to return 'value' to each human. You can inspire us! We need it. Send us [ulogifs](https://ulogs.org/created/ulogifs), [ulog-memes](https://ulogs.org/created/ulog-memes), [ulog-quotes](https://ulogs.org/created/ulog-quotes), [ulography](https://ulogs.org/created/ulography) etc for the sole intention of inspiring us. **Courtesy of your own shine, we can find some shine too!**
`;
