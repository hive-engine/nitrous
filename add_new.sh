...
cp src/app/assets/static/dblog/manifest.json src/app/assets/static/$1/manifest.json
sed -i -e "s!dblog!$1!" src/app/assets/static/$1/manifest.json
sed -i -e "s!Dblog!$2!" src/app/assets/static/$1/manifest.json
