...
export const APP_NAME = 'CreativeCoin';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'CreativeCoin';
export const APP_NAME_UPPERCASE = 'CREATIVECOIN';
export const APP_ICON = 'creativecoin';
...
export const TAG_LIST = List(['creativecoin']);
export const LIQUID_TOKEN = 'CCC';
// sometimes it's impossible to use html tags to style coin name, hence usage of _UPPERCASE modifier
export const LIQUID_TOKEN_UPPERCASE = 'CCC';
// used as backup
export const SCOT_DENOM = 10000;
export const VOTE_WEIGHT_DROPDOWN_THRESHOLD = 1;
export const VESTING_TOKEN = 'CCC POWER';
...
export const SITE_DESCRIPTION =
    'CreativeCoin is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called CCC, that ' +
