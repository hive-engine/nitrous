...
export const APP_NAME = 'Bilpcoin';
...
export const APP_URL = 'https://www.bilpcoin.com';
export const APP_DOMAIN = 'www.bilpcoin.com';
...
// used as backup
export const SCOT_DENOM = 10000000;
export const VOTE_WEIGHT_DROPDOWN_THRESHOLD = 1;
export const VESTING_TOKEN = 'BPC POWER';
...
export const SITE_DESCRIPTION =
    'Bilpcoin is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called BPC, that ' +
