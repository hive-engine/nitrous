...
export const APP_NAME = 'NaturalMedicine';
...
export const APP_DOMAIN = 'www.naturalmedicine.io';
// max num of tags. if unset, default is 10. This is due to previous hardcoded number.
export const APP_MAX_TAG = 10;
export const SCOT_TAG = 'naturalmedicine';
export const TAG_LIST = fromJSOrdered(['naturalhealth', 'herbs', 'cannabis', 'vegan', 'homesteading', 'alternativemedicine', 'essentialoils', 'yoga', 'cbd', 'crystals', 'foodismedicine', 'mushrooms', 'wildcrafting', 'foraging', 'mindfullife', 'ecotrain', 'spirituality', 'meditation', 'permaculture', 'mindfulness', 'wellness', 'plantmedicine', 'herbalmedicine']);
...
export const VESTING_TOKEN = 'LOTUS POWER';
...
export const SITE_DESCRIPTION =
    'NaturalMedicine is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called LOTUS, that ' +
