...
export const APP_NAME = 'SteemInventory';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'SteemInventory';
export const APP_NAME_UPPERCASE = 'STEEMINVENTORY';
export const APP_ICON = 'steeminventory';
...
export const VESTING_TOKEN = 'IV POWER';
...
export const SITE_DESCRIPTION =
    'SteemInventory is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called IV, that ' +
