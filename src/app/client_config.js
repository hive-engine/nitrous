...
export const APP_ICON = 'lassecash';
...
export const SITE_DESCRIPTION =
    'LasseCash is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called LASSECASH, that ' +
...
export const CHAT_CONVERSATION_ID = '01EQBRPV0Q0MB5SYV3K8CJF9T1';
export const CHAT_CONVERSATION_TITLE = 'Lassecash Chat';
