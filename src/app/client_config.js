...
export const APP_NAME = 'Intrepreneur';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'Intrepreneur';
export const APP_NAME_UPPERCASE = 'INTREPRENEUR';
export const APP_ICON = 'intrepreneur';
// FIXME figure out best way to do this on both client and server from env
// vars. client should read $STM_Config, server should read config package.
export const APP_URL = 'https://www.intrepreneur.life';
export const APP_DOMAIN = 'www.intrepreneur.life';
// max num of tags. if unset, default is 10. This is due to previous hardcoded number.
export const APP_MAX_TAG = 10;
export const SCOT_TAG = 'int';
export const TAG_LIST = fromJSOrdered(['int']);
export const LIQUID_TOKEN = 'Int';
// sometimes it's impossible to use html tags to style coin name, hence usage of _UPPERCASE modifier
export const LIQUID_TOKEN_UPPERCASE = 'INT';
// used as backup
export const SCOT_DENOM = 10000;
export const VOTE_WEIGHT_DROPDOWN_THRESHOLD = 1;
export const VESTING_TOKEN = 'INT POWER';
...
export const SITE_DESCRIPTION =
    'Intrepreneur is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called INT, that ' +
