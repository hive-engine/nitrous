...
export default connect(
    ...
    (state, ownProps) => {
        ...
        const commentPool = post.get('parent_author') && scotConfig.getIn(['info', 'enable_comment_reward_pool'], false);
        const pending_rshares = scotConfig.getIn(['info', commentPool ? 'comment_pending_rshares' : 'pending_rshares']);
        const reward_pool = scotConfig.getIn(['info', commentPool ? 'comment_reward_pool', 'reward_pool']);
        const rewardData = {
            pending_rshares,
            reward_pool,
