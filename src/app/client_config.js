...
export const APP_NAME = 'Sagoda';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'Sagoda';
export const APP_NAME_UPPERCASE = 'SAGODA';
export const APP_ICON = 'sago';
// FIXME figure out best way to do this on both client and server from env
// vars. client should read $STM_Config, server should read config package.
export const APP_URL = 'https://www.sagoda.org';
export const APP_DOMAIN = 'www.sagoda.org';
...
export const VESTING_TOKEN = 'SAGO POWER';
...
export const SITE_DESCRIPTION =
    'Sagoda is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called SAGO, that ' +
