...
export const APP_URL = 'https://www.steemsandiego.com';
export const APP_DOMAIN = 'www.steemsandiego.com';
// max num of tags. if unset, default is 10. This is due to previous hardcoded number.
export const APP_MAX_TAG = 10;
export const SCOT_TAG = 'sandiego';
export const TAG_LIST = fromJSOrdered(['sandiego']);
export const LIQUID_TOKEN = 'Sand';
// sometimes it's impossible to use html tags to style coin name, hence usage of _UPPERCASE modifier
export const LIQUID_TOKEN_UPPERCASE = 'SAND';
// used as backup
...
export const COMMUNITY_CATEGORY = 'hive-150033';
