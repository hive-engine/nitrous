...
export function vestingSteem(account, gprops) {
    const vests = parseFloat(account.vesting_shares || 0);
    const total_vests = parseFloat(gprops.total_vesting_shares || 0);
    const total_vest_steem = parseFloat(gprops.total_vesting_fund_steem || 0);
...
export function delegatedSteem(account, gprops) {
    const delegated_vests = parseFloat(account.delegated_vesting_shares || 0);
    const received_vests = parseFloat(account.received_vesting_shares || 0);
