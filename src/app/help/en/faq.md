...
*(Formerly: Nobel Whitepaper
NOBEL worked very well on the Steem platform from Summer 2019 until April 2020. With the fork to Hive, NOBEL is not supported anymore. Instead I have created the new similar token "CHARY". So some text and pictures may use the words "Nobel" or "Steem" but the meaning this is the same like "Chary" or "Hive")* 
<br> 
...
*   The Problem
*   The Solution
*   Six Winning Participants With Chary
*   Some Rules
*   The Whales
*   Chary FAQ
*   Further Information About Chary
*   Disclaimer
*   Contact
*   Steem FAQ
...
[![Nobel Community](https://greensniper.files.wordpress.com/2019/09/nobel_community.jpg)](https://greensniper.files.wordpress.com/2019/09/nobel_community.jpg)                   (Nobel was the precursor from chary. Please use https://chary.org
This is a sketch from Alfred Nobel: ![Nobel_40px](https://greensniper.files.wordpress.com/2019/09/nobel_40px.png))

The Solution:
=============

With the CHARY coin everyone can help to support the supporters. Everyone who has a STEEM-account (you can register [here](https://peakd.com)) can buy CHARY coins on [Hive-Engine.com](https://hive-engine.com/?p=market&t=CHARY). That money stabilizes the price. The coin can then be gifted to people working on charity projects or can be staked and the upvote-power can be used to support the charity helpers. <br>
...
*   *   Chary offers a blockchain based donating system, that eliminates the middlemen.
    *   Chary offers a good hearded community, that brings together charity givers and takers.
    *   Chary offers a sense in this chaotic world and the feeling to be important.
    *   The main goal with the CHARY token is to appreciate humanity.
    *   The actors (more details see below "6 winning participants"):
        *   A donator
            *   can buy CHARY. This money backs the system.
            *   can use the CHARY to donate them directly to charity helpers.
            *   can stake the CHARY and with that she can curate good Proof of Charity.
        *   An Investor
            *   can buy CHARY token and wait until it raises in value.
            *   knows, that his money is placed in a good humanitarian environment.
            *   owns parts of the Chary system. The coins are also shares.
        *   A charity helper
            *   gets support and thanks for his work.
            *   needs to write good posts about his work (Proof of Charity).
        *   A curator
            *   should get some CHARY token and stake them. This gives her higher weighted voting power.
            *   With her upvotes she gives posts with hashtag #chary a value, that is appreciated by the Scotbot.
        *   The Scotbot
            *   This bot has a lot of CHATY token in his backpack.
            *   The bot checks each post on the STEEM blockchain, that is tagged with #chary.
            *   The bot gives the author and the curators a small amount of CHARY, depending on the number and power of upvotes.
        *   The needy people
            *   They just receive attention and a bit hope.
            *   They should be willing to get out of their situation.
    *   The CHARY token is an automated system, based on the Hive blockchain, that warranties, that all these actors find together and that their interactions are fullfilled trustworthy.
    *   There have been 1,000,000,000 (10 ^ 9) CHARY coins created initially on July 19. 2019 by Achim Mertens.
    *   The authors, curators and the token creator earn HIVE also with each post they write or curate. This is their salary. They can also sell the CHARY token, but at least for the whales this should not be the first option to keep the price high and trust into that system.
    *   The frontend is http://chary.org. This has the look and feel like other social medias, except that there is a "price" for each post, that shows the value of CHARY. Other Hive-frontends like https://peakd.com or https://hive.blog/ do also work, then you need some filters to find the chary community (i.e. .../created/chary).
![image.png](https://files.peakd.com/file/peakd-hive/achimmertens/8XczjiQJ-image.png)
...
*   Value for the participants:
    *   The Chary-System was created to be self-amplifying. The more people join, the more stable gets the system. 
    *   The owner of the CHARY tokens are the owner of this system. With their voting power they can influence the next steps. (This is only half true. As long as I (Achim Mertens) keep the keys from @anobel, I can change the system. Maybe we find a more decentralized solution in the future).

*   Measurements:
    *   There are some tools to see what is going on:
        *   [https://chary.org](https://chary.org) (or [https://peakd.com/created/chary](https://peakd.com/created/chary))
            *   This page is the basic entry to the system. There one can see all posts with the hashtag #chary. It is based on the Hive platform. To join you need a Hive account.
        *   [https://hive-engine.com](https://hive-engine.com)
            *   Here you can exchange HIVE into CHARY and backwards. You can claim your CHARY tokens there.
        *   [https://hive-engine.rocks/transactions?symbol=chary](https://hive-engine.rocks/transactions?symbol=chary)
            *   Here you can see who and how many people are transacting CHARY. Also you can observe the Scotbot and check out, if it does what it should do.


*   Monetizing:
    *   When you have a Hive account, you can see the total of all HIVE and subcoins like CHARY in your wallet. You can send Hive to a crypto exchange and there you can receive the money in your local currency.
...
*   Proof of Charity via blockchain is a very new topic. As far as I know is the Chary token system in this form unique. There are some similar systems like:
...
Now they get rewarded for the job they do. They can (and should) sell (or stake) the CHARY coins. The only thing they have to do additional is to write and post about their work to create Proof of Charity and therefore trust into the coin. This is important to increase the value. Please use the hashtags #chary. People, that do charity, should note how much time and how much money they have spend. That gives us a guess how many CHARY this person should get. Old NOBEL example, With CHARY it is similar (originally taken from [@yohanon](https://steempeak.com/@yohan2on)):
...
3\. The Donators
-----------------
Donators have with https://chary.org a tool to gift in three ways: <br>
1. Directly with maximal efficience: <br>
This means, there is no man in the middle. There are only banking exchange fees (that every NGO has to handle with also). When a donator knows who to support, he can give the CHARY or better Hive token directly to the recipient. <br>
2. Supporting The Community: <br>
By buying CHARY and sending it to the distribution bot @anobel, a donator keeps the price high. He puts money into the system. The community distributes CHARY by upvoting, so the "best" charity helpers get the most token, which they can exchange now for a good value on the market. <br>
3. Gaining influence power:<br>
By buying CHARY and staking it, the donator gets an investor and curator<br>
...
*Flyer made with canvas by Achim Mertens (CHARY is the follower of NOBEL)*

![](https://files.steempeak.com/file/steempeak/achimmertens/uw45MAl1-image.png)
*Moneyflow during donation with NOBEL (CHARY is the follower of NOBEL)*
...
The investors can buy new CHARY and therefore give "real" money to the charity helpers. They can stake the coin and hope in a price raise. With staked CHARY they can also curate.

5\. The Curators
----------------
Curators are people that have staked CHARY. They either got it by writing blogs with hashtag #chary and getting upvotes from other CHARY-staker or they have been gifted some CHARY or they have bought it. The more CHARY they have staked, the more CHARY are send from the distribution bot to the author and curators (the staked CHARY are untouched). 5% of the distributed CHARY go to the curators, 95% to the authors.
They can upvote blogs with the hashtag #chary to support the helpers without losing own coins. They can upvote blogs to influence the direction for future steps with the CHARY system. They own a part of the CHARY system.


6\. The System Itself And The Market Members
--------------------------------------------

New members have an ability to invest their money into a system that helps people. So they can win value, if the price rises. And they know, that the money is good invested (even if the price falls). Everyone can write blogs about Chary (with #chary) and when the quality is good they can get upvotes and therefore earn these tokens also. ![NOBEL_Circles](https://greensniper.files.wordpress.com/2019/07/nobel_circles.jpeg)
*NOBEL=CHARY in this picture*


Some Rules To Handle The CHARY Token:
=====================================
...
*   When you have done good things,
    *   please write about it and use the #chary tag. It is important that others get aware of it to find supporters, that buy the token.
    *   sell some of your tokens for a good price. This is necessary to create an economic circle and give the token a value.
*   When you misuse the #chary tag for posts, that have nothing to do with charity or promoting Chary, you will get a nice comment, a warning or a downvote (that also effects your Hive reputation).

You may think "I want to do good things without knowing others about it". Of course this is also ok, but then you cannot find supporters. Your work would get much more effect, when you have a strong team behind you. Therefore it is necessary to get awareness and to give a good proof that you do a good work by writing blogs about it on the Hive-platform.

The Whales (Big Investors)
==========================

A smal group of people has got 10,000.00 token in the beginning. They have some additional duties in their own interest:
...
How do they get value into Chary?
---------------------------------
...
_(left: initial status of NOBEL(also CHARY), right: healthy status of another coin)_ 

Achim (the creator of this token) is going to buy,
*   When people do charity (see example above)
*   about 150 US Dollar/Month (status 2020/08)

If we find more people, that follow my example, then the budget is higher. We need to sell our "idea", not the token. Each tokenbuyer has to be handled like a customer.

What should they upvote?
---------------

With the upvotes from the whales they further incentivise people that are bringing value into our Chary system. This can be advertising/influencing or writing about projects, where the Chary coin is involved. 
![image.png](https://steemitimages.com/0x0/https://files.steempeak.com/file/steempeak/achimmertens/VXn8ovGd-image.png) 
_(Sketch by Achim Mertens)_ 
For details about the configuration of the scotbot see [here](https://steempeak.com/nobel/@achimmertens/the-scotbot-distributes-the-nobel-token-now). The seetings for Chary are the same.

# Chary_FAQ:

**Why should I buy Chary?**
*   Every time you buy Chary, money flows into the system. This money is mentioned for people that do good things. So by buying Chary you contribute to "save the world" ;-).
...
**What can I do with the CHARY coins (use cases)?**
*   You can gift it to people, that do charity. (See also: "To whom can I gift the CHARY?")
...
*   You can send it to @null to burn it and raise the price.
*   You can stake it, to spend it later, when it has (hopefully) more value.
*   You can sell it (for hopefully a better price).
*   You can gift CHARY as a (birthday) present
*   You can use CHARY instead of gaming coins (and gift the pot)
*   You can pay helpers (when they accept it)
*   ... (more ideas welcome)


**Who shall buy the CHARY coins?** 
Everyone can do that. The target group is people, that want to do good things, but don't know how. With buying CHARY you support charity workers. 
![](https://images.hive.blog/0x0/https://files.peakd.com/file/peakd-hive/achimmertens/lkmzVoBa-image.png)
*Moneyflow during donation with CHARY*

**How do I get CHARY?** 
You need to have an account on the Hive blockchain. i.e. you can register here: [https://peakd.com](https://peakd.com). Then you need some HIVE. This you can earn by posting and upvoting or you can exchange it on a bank like [Bitpanda](https://www.bitpanda.com) or [coinmerce](https://coinmerce.io/). With this HIVE you can buy tokens like CHARY here: [https://hive-engine.com/?p=market&t=CHARY](https://hive-engine.com/?p=market&t=CHARY) You can also join our contests or airdrops to earn CHARY (and HIVE at the same time). 
[](https://greensniper.files.wordpress.com/2019/08/howtobuynobeltoken.jpg)

**How does the CHARY increase in value?** 
Sometimes, when you put things together something magic happens: Emergence. For example wind + sand -> wind + sand + dunes. The dunes are the emergence of this system. So it is with tokens that are used by people. The Chary system was mainly built to create a cash flow from financial supporters to charity supporters. This means, I prognose the following phases (with the precondition, that our marketing works):
1.  The price has to find its value (Launch phase July-October 2019)
2.  The price will rise
3.  The price will stabilize


**How big is the risk when I buy CHARY?** 
In that moment you buy, the price increases, which is good for the charity workers. When you gift the coin, then there is a (normal) risk for you, that the recipient do something other with your money. But with the Proof of Charity concept this risk is minimalized. When you keep it, then there is the normal market risk with every coin. The charity helpers sell the coins as soon as they need money. This keeps the risk of market effects for them low. There is a risk, that people get CHARY coins by misusing the #chary tag, getting upvoted by others and then selling the coin. This is not the best idea for these people, because they can also get downvotes, which decreases the value of their posts and their (Hive-) reputation. Especially, when a whale downvotes. But nevertheless, there is a small risk, that people get this coin without deserving it. Let's see in the future how big this effect is. One can observe the CHARY market here: https://hive-engine.rocks/transactions?symbol=CHARY 

**Do daytraders steel FIAT money?**
It looks like, when you buy CHARY. You can often see, that you pay for people or bots, that have bought cheap CHARY and sell them now, when you buy them. This looks like if you support parasits. But on the other hand, they also buy CHARY and give therefore money to the target group, the charity helpers. To sum it up, they neither win nor loose money here. But they help us to close the gap between ask and bid.

**Who is doing the marketing?** 
Everyone who is convinced of Chary or thinks it should be given a try. There are some whales that are eager to see the price rising. 

**How shall we do marketing?**
*   Write about the Chary. Post it on every social media (facebook, instagram, twitter, reddit, ...)
*   Offer contests. I.e.:
    *    "Show me your Charity work and you will get xxx CHARY"
*   We can use the #seven77 movement to make 7 pushups for Hive and Chary
*   Offer xxx CHARY each for the first 10 posts about Chary
*   Offer Airdrops. I.e.:
    *   Buy 100 CHARY and you get 100 CHARY extra

**Who shell sell the CHARY?** 
The CHARY is a free coin on the market, so everyone can sell it. But the aim of this token is, that mainly the people sell it, that have done charity. You can sell (or change) CHARY here: [https://hive-engine.com/?p=market&t=CHARY](https://hive-engine.com/?p=market&t=CHARY) 

**What makes the CHARY unique?**
> The Chary is an high effective charity distribution tool, where the donators either directly support their favorite charity workers or leave it up to the community to care about, that the money goes to the right places. The charity workers do “Proof of Charity” by writing blogs about their work. Hive (the base of Chary) is a great blockchain protocol with a big and good minded community, that creates value by connecting the right people. No NGO or middleman is needed.

The aim of the token is not mainly to get rich of it or to create financial value (when the price rises and you have staked CHARY, you can also profit from it monetary), it is more a cashflow: With buying CHARY, money comes in, with spending money by the charity helpers, money goes out. 

**To whom can I gift the CHARY?** 
The target group is people that help other people. This can be your neighbor who helps you (or others) in the garden, but also charity helpers somewhere in the world. You can find them with the hashtag #chary on the [hive plattform](https://peakd.com/created/chary). But you can also send it to charity groups like [@fundition](https://steempeak.com/@fundition), ... They will use the money like an NGO to support the supporters. 
@achimmertens creates regularely a post with a positive list of people, that have been proven as trustworthy to him.
Here is an example from August 2020:
|Hive-Member|Website|Comment|
|-|-|-|
|@elkezaksek|https://www.leetchi.com/c/soziales-von-elke-zaksek|She supports needy people in Uganda. Usually she buys solar panels for families. We chatted a lot via Hive.|
|@m-tennis-academy|https://www.chary.org/@m-tennis-academy|This is @yohan2on, who plays tennis with kids and supports  needy people in Uganda (I know him personally).|
|@dfacademy|https://medium.com/@dfacademy/decentralized-football-academy-dfa-a-nigerian-charitable-football-soccer-academy-8b2c8e4beedb|They play football in Nigeria with children. They have proven two times to me, that they are trustworthy and don't waste money. |
|@battebilly|https://m.facebook.com/steemituganda|He supports needy people in Uganda|
|@hope.venezuela|https://www.chary.org/@hope.venezuela| @fucho80 (a pastor) supports needy people in Venezuela.|
|@hiveuacharity|https://www.chary.org/@hiveuacharity|@rollie1212 (I know him personally) and others are behind this project. They support charity projects in the Ukraine.|
|@papilloncharity|http://www.papillonfoundation.com/| He delivered good proof of charity (see [here](https://peakd.com/hive-174578/@papilloncharity/why-do-we-say-that-we-are-verified))|

Honor people that do good things like in the next question: 

**What kind of charity can I do to get CHARY?** 
Everything is allowed that helps other people and do not harm someone else. The more work and effort you invest and the more it helps, the more token you should get. Here are some examples:
...
*   Get an account on https://peakd.com
*   Do something good to other (needy) people
*   Write a blog about it on https://peakd.com (or another frontend for Hive)
...
*   Use the hashtag #chary (see the example above under "Charity Helpers").
Then you should hopefully get some of the coins. 

## Further Information About NOBEL:
Nobel was the former system on the Steem platform. With Hive everything exept the name stays the same.
...
## Some Voices From Nobel/Chary Participants
...
I am not responsible for your invests. The CHARY and HIVE tokens are cryptocurrencies and underly the laws of the market, which I am not responsible for. </br>

Contact
===========

Achim Mertens </br>
https://chary.org/@achimmertens <br>
https://peakd.com/@achimmertens <br>
twitter: @greensniper <br>
mail: achim_mertens@gmx.de (use "#chary" in the mail header) 
