...
const HIVEHUSTLERS = {
    ...
    APP_ICON_WIDTH: '40px',
    APP_ICON_HEIGHT: '40px',
    APP_URL: 'https://www.hivehustlers.com',
    APP_DOMAIN: 'www.hivehustlers.com',
...
const ALIVE = {
    ...
    APP_ICON_HEIGHT: '40px',
    APP_URL: 'https://www.wearealivetribe.com',
    APP_DOMAIN: 'www.wearealivetribe.com',
    LIQUID_TOKEN: 'Alive',
...
const ARCHON = {
    ...
    APP_ICON_WIDTH: '40px',
    APP_ICON_HEIGHT: '40px',
    APP_URL: 'https://archon.crypto-dreamr.com',
    APP_DOMAIN: 'archon.crypto-dreamr.com',
    LIQUID_TOKEN: 'Archon',
...
const BROADHIVE = {
    APP_NAME: 'Blogminth',
    APP_ICON: 'blogminth',
    APP_ICON_WIDTH: '144px',
    APP_ICON_HEIGHT: '40px',
    APP_URL: 'https://www.blogminth.com',
    APP_DOMAIN: 'www.blogminth.com',
    LIQUID_TOKEN: 'BHT',
    LIQUID_TOKEN_UPPERCASE: 'BHT',
    APP_MAX_TAG: 10,
    SCOT_TAG: 'broadhive',
    TAG_LIST: fromJSOrdered(['broadhive', 'bhive', 'blogminth']),
    INTERLEAVE_PROMOTED: true,
    PROMOTED_POST_ACCOUNT: 'null',
