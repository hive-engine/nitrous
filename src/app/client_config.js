...
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'Tunes';
export const APP_NAME_UPPERCASE = 'TUNES';
export const APP_ICON = 'tunes';
// FIXME figure out best way to do this on both client and server from env
// vars. client should read $STM_Config, server should read config package.
export const APP_URL = 'https://www.tunestoken.com';
export const APP_DOMAIN = 'www.tunestoken.com';
// max num of tags. if unset, default is 10. This is due to previous hardcoded number.
export const APP_MAX_TAG = 10;
export const SCOT_TAG = 'tunes';
export const TAG_LIST = fromJSOrdered(['tunes']);
export const LIQUID_TOKEN = 'Tunes';
// sometimes it's impossible to use html tags to style coin name, hence usage of _UPPERCASE modifier
export const LIQUID_TOKEN_UPPERCASE = 'TUNES';
// used as backup
export const SCOT_DENOM = 100000000;
export const VOTE_WEIGHT_DROPDOWN_THRESHOLD = 1;
export const VESTING_TOKEN = 'TUNES POWER';
...
export const SITE_DESCRIPTION =
    'Tunes is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called TUNES, that ' +
