const map = {
    // default
    '':
        "Our communities are overseen by *'certified uloggers'* only. Get *'certified'* **[here](https://www.marlians.com/marlians/@surpassinggoogle/simplified-process-for-becoming-a-certified-ulogger-now-4-very-simple-steps-only-chinese-and-korean-translation-available)**`; then, indicate your interest in overseeing a community by contacting '@surpassinggoogle#1660' on [discord](https://discord.gg/nHVV5e9)",
