...
export const APP_NAME = 'ActnEarn';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'ActnEarn';
export const APP_NAME_UPPERCASE = 'ACTNEARN';
export const APP_ICON = 'actnearn';
...
export const VESTING_TOKEN = 'ACTNEARN POWER';
...
export const SITE_DESCRIPTION =
    'ActnEarn is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called ACTNEARN, that ' +
...
// Revive Ads
export const NO_ADS_STAKE_THRESHOLD = 999999999999;
