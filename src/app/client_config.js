...
export const APP_NAME = 'SonicGroove';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'SonicGroove';
export const APP_NAME_UPPERCASE = 'SONICGROOVE';
export const APP_ICON = 'sonic';
// FIXME figure out best way to do this on both client and server from env
// vars. client should read $STM_Config, server should read config package.
export const APP_URL = 'https://www.sonicgroove.net';
export const APP_DOMAIN = 'www.sonicgroove.net';
// max num of tags. if unset, default is 10. This is due to previous hardcoded number.
export const APP_MAX_TAG = 10;
export const SCOT_TAG = 'sonicgroove';
export const TAG_LIST = fromJSOrdered(['sonicgroove']);
export const LIQUID_TOKEN = 'Sonic';
// sometimes it's impossible to use html tags to style coin name, hence usage of _UPPERCASE modifier
export const LIQUID_TOKEN_UPPERCASE = 'SONIC';
// used as backup
export const SCOT_DENOM = 1000000;
export const VOTE_WEIGHT_DROPDOWN_THRESHOLD = 1;
export const VESTING_TOKEN = 'SONIC POWER';
...
export const SITE_DESCRIPTION =
    'SonicGroove is a social media platform where everyone gets paid for ' +
    'creating and curating content. It leverages a robust digital points system, called SONIC, that ' +
